...
// ── DATA ────────────────────────────────────────────────────────────────
var ALLOWED_USERNAMES = ["nilton","juselina","celso","tamara","erick"];
var USERS = [
  { username:"nilton",   realName:"Nilton",   color:"#7C3AED" },
  { username:"juselina", realName:"Juselina", color:"#DB2777" },
  { username:"celso",    realName:"Celso",    color:"#059669" },
  { username:"tamara",   realName:"Tamara",   color:"#D97706" },
...
var JEEP_LIST = [
  { name:"Nilton",   username:"nilton",   color:"#7C3AED", entidade:"Ludoteca Municipal Cascais",     estado:"verde" },
  { name:"Juselina", username:"juselina", color:"#DB2777", entidade:"Biblioteca S. Domingos de Rana", estado:"amarelo" },
  { name:"Celso",    username:"celso",    color:"#059669", entidade:"CPCJ Cascais",                   estado:"verde" },
  { name:"Tamara",   username:"tamara",   color:"#D97706", entidade:"ATL Miraflores",                 estado:"vermelho" },
  { name:"Erick",    username:"erick",    color:"#2563EB", entidade:"Câmara de Cascais - DRH",        estado:"verde" },
];
      ...
      <div style={{ minHeight:"100vh", background:"linear-gradient(150deg,#0f172a 0%,#1e293b 55%,#0d3320 100%)", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"system-ui,sans-serif" }}>
        <div style={{ background:"white", borderRadius:28, padding:"40px 34px", width:320, boxShadow:"0 40px 100px rgba(0,0,0,0.5)" }}>
          ...
          <div style={{ marginTop:14, padding:"12px 14px", background:"#f8fafc", borderRadius:12, fontSize:11, color:"#94a3b8", lineHeight:1.7 }}>
            <b style={{ color:"#64748b" }}>Utilizadores:</b> nilton / juselina / celso / tamara / erick<br/>
