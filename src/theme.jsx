...
// Mantemos o azul marinho profundo e os néons do teu logo
export const BG  = "#070b14"; 
export const PNK = "#f472b6"; 
export const CYN = "#22d3ee"; 
export const DRK = "#0f172a";

// ── CONFIGURAÇÃO GLOBAL DO BROWSER ──
// Isto garante que o fundo é escuro logo ao carregar, sem "flashes" brancos
...
// ── O VISUAL GLASSMORPHISM (CLEAN & TRANSPARENTE) ──
export const CARD = {
  ...
  border: "1px solid rgba(34, 211, 238, 0.15)", // Borda ciano suave original
...
// ── COMPONENTE DO LOGOTIPO (ROBUSTO) ──
  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", padding: "10px 0", width: "100%" }}>
      <img 
        ...
        onError={(e) => {
          // Se falhar o logo.png.png, tenta o logo.png simples
          if (!e.target.src.includes("logo.png.png")) {
...
// ── BOTÕES NÉON (VARIÁVEIS DE FUNÇÃO) ──
...
// ── BARRA DE PROGRESSO (TERMÓMETRO DO PIA) ──
