      ...
      <div style={CARD}>
        ...
        <div style={{ display:"flex", gap:10, marginBottom:16 }}>
          <a href="https://wa.me/351916025666" target="_blank" rel="noreferrer" style={{
            ...
            border: light ? "1px solid rgba(37,211,102,0.35)" : "1px solid rgba(50,199,255,0.12)" }}>
          ...
          <a href="mailto:teresa.castro@cm-cascais.pt" style={{
            flex:1, background: light ? "rgba(33,150,243,0.10)" : "rgba(14,36,68,0.9)", color: light ? "#1d4ed8" : "#B8C7DA",
            textDecoration:"none", padding:"13px 12px", borderRadius:14, textAlign:"center",
            fontWeight:700, fontSize:12, display:"flex", alignItems:"center", justifyContent:"center", gap:8,
            border: light ? "1px solid rgba(33,150,243,0.30)" : "1px solid rgba(50,199,255,0.12)" }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#2196F3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
            Email
          </a>
        </div>
