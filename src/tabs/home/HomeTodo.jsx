      ...
      {acoesPendentes.length > 0 && (
        <div style={{ marginBottom:20 }}>
          ...
          {acoesPendentes.map((item, idx) => {
            ...
            const LIGHT_CARD_BG = { urgent:"linear-gradient(135deg,#f43f5e,#e11d48)", pending:"linear-gradient(135deg,#f59e0b,#d97706)", new:"linear-gradient(135deg,#8b5cf6,#7c3aed)" };
            ...
            <div key={idx} onClick={item.go} style={{
              ...
              <div style={{ flex:1 }}>
                ...
                <div style={{ fontSize:11, color: light ? "rgba(255,255,255,0.80)" : "#94a3b8", marginTop:2 }}>{item.sub}</div>
                {item.prazo && (
              ...
              <div style={{ color: light ? "rgba(255,255,255,0.70)" : PS[item.status].bc, fontWeight:900, fontSize:18, opacity:0.8 }}>›</div>
            </div>
            );
          })}
        </div>
