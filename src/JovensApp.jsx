          ...
          <div style={{ display:"flex", alignItems:"center", gap:12 }}>
            ...
            <div>
              ...
              <div style={{ display:"flex", gap:6, marginTop:4, flexWrap:"wrap" }}>
                {(allData.userData.dayStreak || 0) > 0 && (
                  <div style={{ fontSize:10, background:"rgba(0,0,0,0.2)", borderRadius:20, padding:"2px 8px", fontWeight:800, color:"white", display:"inline-block" }}>
                    🔥 {allData.userData.dayStreak} dia{allData.userData.dayStreak > 1 ? "s" : ""}
                  </div>
                )}
                <div style={{ fontSize:10, background:"rgba(0,0,0,0.2)", borderRadius:20, padding:"2px 8px", fontWeight:800, color:"white", display:"inline-block" }}>
